        ...
        return (
            <View style={styles.eventBox}>
                <View style={styles.eventBlock}>
                    <Text style={styles.eventThumb}>  <Thumbnail square smallsource={{ uri: 'http://www.people.okanagan.bc.ca/rjanyk/Images/Icons_Buttons/Graphs_Stats/bar_graph.png' }} /></Text>
                </View>
