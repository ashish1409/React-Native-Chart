      ...
      data: {
        dataSets: [{
          ...
          config: {
            ...
            shadowColor: processColor('#a9b0bb'),
            shadowWidth: 1,
      ...
      <SafeAreaView style={styles.SafeAreaView}>
        <View style={styles.eventBox}>
          <View style={styles.eventBlock}>
            <Text style={styles.eventThumb}>  <Thumbnail square source={require('../../assets/candle-chart.png')} /></Text>
          </View>
